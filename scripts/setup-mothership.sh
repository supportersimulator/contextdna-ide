...
echo ""
echo "  ${BOLD}Then: install + wire up the Claude Code ecosystem${RESET}"
echo "    Run: ${BLUE}bash scripts/configure-ecosystem.sh${RESET}"
echo "    Probes + installs (each opt-in):"
echo "             Multi-Fleet (cross-machine AI coordination + plugin)"
echo "             3-Surgeons (multi-model consensus + plugin)"
echo "             Superpowers (Claude Code skills marketplace)"
echo "             MCP wiring (validates all 7 MCP servers registered)"
echo ""
